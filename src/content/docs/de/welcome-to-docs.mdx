...
<CardGrid stagger>
  ...
  <Card title="Werkzeuge & Ausrüstung" icon="seti:eslint">
    Entdecken Sie die vollständige Palette hochwertiger Werkzeuge und Ausrüstungen von Zestha Vutura. Jeder Unterabschnitt bietet detaillierte Spezifikationen, Gebrauchsanweisungen und Wartungstipps.
  </Card>
