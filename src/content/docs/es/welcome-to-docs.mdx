...
<CardGrid stagger>
  ...
  <Card title="Herramientas y Equipos" icon="seti:eslint">
    Descubre la línea completa de herramientas y equipos de calidad superior de Zestha Vutura. Cada subsección ofrece especificaciones detalladas, instrucciones de uso y consejos de mantenimiento.
  </Card>
