...
hero:
  ...
  actions:
    ...
    - text: View on GitHub
      icon: external
      link: https://github.com/mearashadowfax/Zestha Vutura
---
...
<CardGrid stagger>
  ...
  <Card title="Outils et Équipements" icon="seti:eslint">
    Découvrez la gamme complète d'outils et d'équipements de qualité supérieure de Zestha Vutura. Chaque sous-section offre des spécifications détaillées, des instructions d'utilisation et des conseils de maintenance.
  </Card>
