...
<CardGrid stagger>
  ...
  <Card title="Tools & Equipment" icon="seti:eslint">
    Discover the complete lineup of Zestha Vutura's superior quality tools and equipment. Each subsection offers detailed specifications, usage instructions, and maintenance tips.
  </Card>
